    ...
    <div style="padding:5px">
        ...
        <div style="float:left;width:50%;background:#fff">
            ...
            <div class="modal-field">
                <div class="modal-field-input" style="width:100%">
                    ...
                    <div class="input" style="width:45%"><input type="text" name="pm_once_price" class="border-no" value="<?=$info["pm_once_price"]?>" onfocus="$(this).removeClass('border-no')" onfocusout="$(this).addClass('border-no')"></div>
                </div>
            </div>
            <div class="modal-field">
                <div class="modal-field-input" style="width:100%">
                    <div class="label" style="width:35%"><div>할인 금액</div></div>
                    <div class="input" style="width:45%"><input type="text" name="pm_once_dis_price" class="border-no" value="<?=$info["pm_once_dis_price"]?>" onfocus="$(this).removeClass('border-no')" onfocusout="$(this).addClass('border-no')"></div>
                </div>
            </div>
            <div class="modal-field">
                <div class="modal-field-input" style="width:100%">
                    <div class="label" style="width:35%"><div>할인 사유</div></div>
                    <div class="input" style="width:45%"><input type="text" name="pm_once_dis_msg" class="border-no" value="<?=$info["pm_once_dis_price"]?>" onfocus="$(this).removeClass('border-no')" onfocusout="$(this).addClass('border-no')"></div>
                </div>
            </div>
            <div class="modal-field">
                <div class="modal-field-input" style="width:100%">
            ...
            <div class="modal-field">
                <div class="modal-field-input" style="width:100%">
                    ...
                    <div class="input" id="p_pm_first_price1"><?=$info["pm_first_day_price"]?></div>
                </div>
            </div>
        </div>
        <div style="float:right;width:50%;background:#fff">
            ...
            <div class="modal-field">
                <div class="modal-field-input" style="width:100%">
                    ...
                    <div class="input" style="width:45%"><input type="text" name="pm_service_price" class="border-no" value="<?=$info["pm_service_price"]?>" onfocus="$(this).removeClass('border-no')" onfocusout="$(this).addClass('border-no')"></div>
            ...
            <div class="modal-field">
                <div class="modal-field-input" style="width:100%">
                    ...
                    <?php else: ?>
                        <div class="input" id="p_month_date" style="text-align:right;width:45%"><?=$info["pm_first_month_start"]?> ~ <?=$info["pm_first_month_end"]?> (<?=$info["pm_pay_period"]?>개월)</div>
                    <?php endif; ?>
            ...
            <div class="modal-field">
                <div class="modal-field-input" style="width:100%">
                    ...
                    <div class="input" id="p_month_price2" style="text-align:right;width:45%"><?=$info["pm_first_month_price"]?></div>
            ...
            <div class="modal-field">
                <div class="modal-field-input" style="width:100%">
                    ...
                    <div class="input" id="p_month_price4" style="text-align:right;width:45%"><?=$info["pm_first_month_price"]?></div>
                    <div style="display:inline-block">원 / <span class="total_contract"></span>개월</div>
                </div>
            </div>
        ...
        <div class="modal-field">
            ...
            <div class="modal-field-input">
                ...
                <div class="input" id="p_pm_total_price2"><?=$info["pm_once_price"]-$info["pm_once_dis_price"]+$info["pm_service_price"]-$info["pm_service_dis_price"]-$info["pm_payment_dis_price"]?></div>
            </div>
        </div>
        <div class="modal-field">
            <div class="modal-field-input">
                <div class="label"><div>초기 일할 요금</div></div>
                <div class="input" id="p_pm_total_price3"><?=$info["pm_first_day_price"]?></div>
            </div>

            <div class="modal-field-input">
                <div class="label"><div>부가세</div></div>
                <div class="input" id="p_pm_total_price4">
                    <?=($info["pm_once_price"]-$info["pm_once_dis_price"]+$info["pm_service_price"]-$info["pm_service_dis_price"]-$info["pm_payment_dis_price"])*0.1?>
                </div>
            </div>
        </div>
        <div class="modal-field">
            <div class="modal-field-input">
                ...
                <div class="input" id="p_pm_total_price5"><?=$info["pm_service_price"]-$info["pm_service_dis_price"]-$info["pm_payment_dis_price"]?></div>
            </div>

            <div class="modal-field-input">
                <div class="label"><div>총 결제 합계</div></div>
                <div class="input" id="p_pm_total_price6">
                    <?=($info["pm_once_price"]-$info["pm_once_dis_price"]+$info["pm_service_price"]-$info["pm_service_dis_price"]-$info["pm_payment_dis_price"])*1.1?>
                </div>
            </div>
        </div>
        <div class="modal-title">
