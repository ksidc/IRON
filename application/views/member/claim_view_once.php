    ...
    <div style="padding:5px">
        ...
        <div class="modal-field">
            ...
            <div class="modal-field-input">
                ...
                <div class="input right" id="p_pm_total_price2"><?=number_format($info["pm_once_price"]-$info["pm_once_dis_price"]+$info["pm_first_day_price"])?> 원</div>
        ...
        <div class="modal-field">
            <div class="modal-field-input">
                ...
                <div class="input right" id="p_pm_total_price3"></div>
            </div>
        ...
        <div class="modal-field">
            <div class="modal-field-input">
                ...
                <div class="input right" id="p_pm_total_price5"></div>
