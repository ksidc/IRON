    ...
    public function make($pc_seq,$pr_seq=""){
        ...
        foreach($divinfo as $row){
            ...
            foreach($subdiv as $row2){
                ...
                <td><input type="text" name="prs_month_price[]" value="'.number_format($row2["prs_month_price"]).'" style="width:80px;ime-mode:disabled" onkeypress="return onlyNumDecimalInput(this);" onkeyup="fn_press_han(this)">원/월</td>
